...
if ($uidd != $user_id) {
    $_SESSION['msg'] = "<span class='alert alert-danger'>Cannot Add Summary To Another User's Activity.</span>";
...
if ($unplanned != '' or $planned != '' or $unresolved != '' or $issues != '') {
    header("Location: editsummary.php?week_token=".$wik."&month=".$month."&week=".$week."&year=".$year."");
}
                        ...
                        <div class="">
                            <form method="post" action="activityprocessing.php" name="issue_form" id="issue_form" enctype="multipart/form-data">
                                <div class="login-form-body">
                                    <div class="row">
                                        <h5>Input Summary For Week <?php  echo $week_array; ?></h5><br><br>
                                        <?php 
