                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span></span></li>
                                <li><span></span></li>
                                <li><button id="newissue" class="btn btn-primary btn-flat" data-toggle="modal" data-target=".newissue">New State</button></li>
                                <li>
                                <?php 
                                ...
                                <div class="data-tables datatable-primary">
                                    <div id="my_table">
                                        <table id="dataTable2" class="text-center table table-hover">
                                            ...
                                            <tbody>
                                                <?php
                                                $il = mysqli_query($conn, "SELECT * from state");
                                                $sn = 1;
                                                while ($li_row = mysqli_fetch_array($il)) {
                              
                                                ?>
                                                <tr>
                                                    <td><?php echo $li_row['state_code'] ; ?></td>
                                                    <td><?php echo $li_row['state_name'] ; ?></td>
                                                                ...
                                                                <div class="container">
                                                                        <form action="processing.php" method="post">
                                                                            ...
                                                                            <div class="login-form-body">
                                                                                <div class="form-gp">
                                                                                    <input type="text" placeholder="Enter State Code" name="fcode" value="<?php echo $li_row['state_code']; ?>" required>
                                                                                    
                                                                                    <div id="errfc"></div>
                                                                                </div>
                                                                                <div class="form-gp">
                                                                                    <input type="text" name="fname" placeholder="State Name" value="<?php echo $li_row['state_name']; ?>" required>
                                                ...
                                                <form action="javascript:;">
                                                    ...
                                                    <div class="login-form-body">
                                                        <div class="form-gp">
                                                            ...
                                                            <input type="text" id="scode" required>
